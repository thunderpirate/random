...
to_publish=to_publish[['Total points','group qual. points','group game points','played','ppg','Team 1','Team 2','Team 3','Team 4']].sort_values(by=['Total points'],ascending=False
